...
<body>
	...
	<form action="insertRecensione.php" method="POST">
		<div class="container pt-5">
			<div class="row">
				<div class="col-6">
						<h3>Valuta la tua esperienza<h3>
						<input type="number" name="voto" id="voto" style="width: 10%;" min="1" max="5">
						<br>

						<h3>Raccontaci la tua esperienza<h3>
							<textarea class="form-control" placeholder="Scrivi qui."></textarea>
						<br>
						
						<h3>Dai un titolo alla tua recensione<h3>
						<input type="text" name="titolo" id="" class="form-control" placeholder="Scrivi qui" >	
				</div>
				<div class="col-6">
					<div class="dropdown">
			...
			<br>
			<input type="submit" value="Invia" style="border-radius: 25px; background-color: #00E1A5;">
			<br>
			<br>
		</div>
	</form>
